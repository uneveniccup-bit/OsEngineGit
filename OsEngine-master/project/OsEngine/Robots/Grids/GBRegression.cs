...
{
    [Bot("GBRegression")]
    public class GBRegression : BotPanel
    {
        ...
        private StrategyParameterDecimal _stepMulti;
        private StrategyParameterDecimal _profitMulti;
        ...
        public GBRegression(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            _stepMulti = CreateParameter("StepMulti)", 1.0m, 1, 2, 0.1m, "Grid");
            _profitMulti = CreateParameter("ProfitMulti)", 1.0m, 1, 2, 0.1m, "Grid");
        ...
        private void LogicCreateGrid(List<Candle> candles)
        {
                ...
                || lastPrice < lastDownLine)
            {
                ...
                grid.GridCreator.ProfitMultiplicator = _profitMulti.ValueDecimal;
                grid.GridCreator.StepMultiplicator = _stepMulti.ValueDecimal;
